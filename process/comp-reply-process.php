...
<?php 
    ...
    if(isset($_GET['ticketID'])){
		...
		$query = ("SELECT * FROM usercomplaint WHERE ticketID =  '$ticket'");
    ...
    if(isset($_POST['submit'])){
		...
		$query = "INSERT INTO comment (comments, type, ticketID, userID) VALUES('$comment', 'admin', '$ticketID', '$userID')";
		...
		if($tbl == true) {
            ...
            Swal.fire({
				...
				window.location.href = './view-user-comp-reply.php?ticketID=$ticketID';
