...
<?php require_once "process/comp-reply-process.php"  ?>
<!DOCTYPE html>
<html>
<head>
...
?>
  ...
  <div class="row">
      ...
      <form action="view-user-comp-reply.php" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-25">
    ...
    <script>
        // JavaScript to clear the text area when the cancel button is clicked
